...
urlpatterns = [
    ...
    path("buy/<str:post_token>", views.BuyProductView.as_view(), name="addon.product.buy"),
    path("buy/<str:post_token>/demo", views.ProductDemoView.as_view(), name="addon.product.demo"),
]
